...
Version  : 3.4.1
Release  : 40
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/spatstat.geom_3.4-1.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/spatstat.geom_3.4-1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747751924
